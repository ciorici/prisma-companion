 ...
 * @package Prisma Companion
 */
final class Prisma_Companion_Demo_Library_Page {
	...
	/**
	 * Main Prisma Companion Demo Library Page Instance.
	 *
	 * @since 1.0.0
	 * @return Prisma_Companion_Demo_Library_Page
	 */
	public static function instance() {

		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Prisma_Companion_Demo_Library_Page ) ) {
	...
	public function __construct() {
		...
		do_action( 'prisma_companion_demo_library_page_loaded' );
	}
	...
	public function add_admin_menu() {
		...
		add_submenu_page(
			...
			esc_html__( 'Demo Library', 'prisma-companion' ),
			'Demo Library',
		...
		<div class="pc-container">
			...
			<div class="prisma-core-section-title">
				...
				<div class="demo-search">
					<input type="search" placeholder="<?php esc_html_e( 'Filter&hellip;', 'prisma-companion' ); ?>" id="prisma-companion-search-demos" />
			...
			<div class="demo-filters">
				...
				<ul class="demo-categories">
					<li class="selected" data-category=""><a href="#"><?php esc_html_e( 'All', 'prisma-companion' ); ?></a></li>
					<li><a href="#" data-category="blog"><?php esc_html_e( 'Blog', 'prisma-companion' ); ?></a></li>
					<li><a href="#" data-category="shop"><?php esc_html_e( 'Shop', 'prisma-companion' ); ?></a></li>
				</ul>

				<ul class="demo-builders">
					<li class="selected"><a href="#" data-builder="block-editor"><?php esc_html_e( 'Gutenberg', 'prisma-companion' ); ?></a></li>
				</ul>
			</div>

			<div class="prisma-core-section prisma-core-columns demos">
			</div><!-- END .demos -->

			<p class="demo-notice">
				<?php esc_html_e( 'New demos coming soon', 'prisma-companion' ); ?>
			</p>
	...
	public function print_templates() {
		?>
		<script type="text/template" id="tmpl-prisma-companion-template">
		</script>

		<script type="text/template" id="tmpl-prisma-companion-demo-item">
			<div class="prisma-core-column">
				<div class="prisma-companion-demo"
		...
		<script type="text/template" id="tmpl-prisma-companion-demo-preview">

			<div class="prisma-companion-demo-preview theme-install-overlay wp-full-overlay expanded">
				...
				<div class="wp-full-overlay-sidebar">
					...
					<div class="wp-full-overlay-header"
						...
						<button class="close-full-overlay"><span class="screen-reader-text"><?php esc_html_e( 'Close', 'prisma-companion' ); ?></span></button>
					...
					<div class="wp-full-overlay-sidebar-content">
						<div class="install-theme-info">
							...
							<div class="pc-demo-name">
								<span><?php esc_html_e( 'You are previewing', 'prisma-companion' ); ?></span>
								<h3>{{{data.name}}}</h3>
							</div>
							...
							<div class="pc-demo-section">

								<div class="pc-demo-section-title">
									<span class="control-heading"><?php esc_html_e( 'Import Options', 'prisma-companion' ); ?></span>
								...
								<div class="pc-demo-section-content import-options">
									<p>
										<label class="pc-checkbox">
											<input type="checkbox" checked name="import_customizer" id="import_customizer" />
											<span class="pc-label"><?php esc_html_e( 'Import Customizer Settings', 'prisma-companion' ); ?></span>
										</label>
									</p>
									...
									<p>
										<label class="pc-checkbox">
											...
											<span class="pc-label"><?php esc_html_e( 'Import Content', 'prisma-companion' ); ?></span>
											<span class="pc-tooltip" data-tooltip="<?php esc_html_e( 'Import pages, posts and menus from this demo.', 'prisma-companion' ); ?>"><span class="dashicons dashicons-editor-help"></span>
										</label>
									</p>
									...
									<p>
										<label class="pc-checkbox">
											...
											<span class="pc-label"><?php esc_html_e( 'Import Media', 'prisma-companion' ); ?></span>
										</label>
									</p>
									...
									<p>
										<label class="pc-checkbox">
											...
											<span class="pc-label"><?php esc_html_e( 'Import Widgets', 'prisma-companion' ); ?></span>
										</label>
									</p>
							...
							<# if ( ! _.isEmpty( data.required_plugins ) ) { #>
								...
								<div class="pc-demo-section">
									<div class="pc-demo-section-title">
										<span class="control-heading"><?php esc_html_e( 'Plugins Used in This Demo', 'prisma-companion' ); ?> ({{{ _.size( data.required_plugins )}}})</span>
										<span class="control-toggle">
									...
									<div class="pc-demo-section-content plugin-list">

										<# _.each( data.required_plugins, function( plugin ) { #>

											<p>
												<label class="pc-checkbox plugin-{{plugin.status}}">
													...
													<span class="pc-label">{{{plugin.name}}}</span>

													<# if ( 'active' === plugin.status ) { #>
														<em><i class="dashicons dashicons-yes"></i><?php esc_html_e( 'Already installed', 'prisma-companion' ); ?></em>
													<# } #>
												</label>
											</p>
										...
										<em class="theme-description"><?php esc_html_e( 'These plugins will be auto-installed for you.', 'prisma-companion' ); ?></em>
									</div>
								</div>
					...
					<div class="wp-full-overlay-footer">
						<div class="footer-import-button-wrap">
							...
							<div id="pc-progress-bar">
								<div class="pc-progress-percentage"></div>
							</div>
						</div>
						<button type="button" class="collapse-sidebar button" aria-expanded="true"
								aria-label="<?php esc_html_e( 'Collapse Sidebar', 'prisma-companion' ); ?>">
							<span class="collapse-sidebar-arrow"></span>
							<span class="collapse-sidebar-label"><?php esc_html_e( 'Collapse', 'prisma-companion' ); ?></span>
						</button>

						<div class="devices-wrapper">
							<div class="devices">
								<button type="button" class="preview-desktop active" aria-pressed="true" data-device="desktop">
									<span class="screen-reader-text"><?php esc_html_e( 'Enter desktop preview mode', 'prisma-companion' ); ?></span>
								</button>
								<button type="button" class="preview-tablet" aria-pressed="false" data-device="tablet">
									<span class="screen-reader-text"><?php esc_html_e( 'Enter tablet preview mode', 'prisma-companion' ); ?></span>
								</button>
								<button type="button" class="preview-mobile" aria-pressed="false" data-device="mobile">
									<span class="screen-reader-text"><?php esc_html_e( 'Enter mobile preview mode', 'prisma-companion' ); ?></span>
								</button>
							</div>
						</div>
				...
				<div class="wp-full-overlay-main">
					<iframe src="{{{data.url}}}" title="<?php esc_attr_e( 'Preview', 'prisma-companion' ); ?>"></iframe>
				</div>
			</div>
		</script>
		<?php
	...
	/**
	 * Add tabs to Prisma Core Dashboard page.
	 *
	 * @since 1.0.0
	...
	public function update_navigation_items( $items ) {
		...
		$demo = array(
			'demo-library' => array(
				'id'    => 'demo-library',
				'name'  => esc_html__( 'Demo Library', 'prisma-companion' ),
				'icon'  => '',
				'url'   => admin_url( 'admin.php?page=prisma-core-demo-library' ),
			),
		);

		$items = prisma_core_array_insert( $items, $demo, 'changelog', 'before' );
...
/**
 * The function which returns the one Prisma_Companion_Demo_Library_Page instance.
 *
 * Use this function like you would a global variable, except without needing
 * to declare the global.
 *
 * Example: <?php $prisma_companion_demo_library_page = prisma_companion_demo_library_page(); ?>
 *
 * @since 1.0.0
 * @return object
 */
function prisma_companion_demo_library_page() {
	return Prisma_Companion_Demo_Library_Page::instance();
}

prisma_companion_demo_library_page();
